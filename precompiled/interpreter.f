push: Generated_from_lib/stage0.flpc_lib/stage1a.flpc_lib/stage1b.flpc_lib/stage1b2.flpc_lib/stage1b3.flpc_lib/stage1c.flpc_lib/stage1d.flpc_lib/stage3a.flpc_lib/stage3b.flpc_lib/flpc_grammar.flpc_lib/stage6a.flpc_lib/stage6b.flpc_lib/stage7a2.flpc_lib/stage7a.flpc_-o_precompiled/interpreter.f print
...
[ 
  pick: l pick: index - 1 - pick: iterable attr_call: get tprint ] bind: autogen685 
[ newfunc1 assign: iterable 
   pick: iterable attr: len assign: l 
   pick: l 0 pushf: autogen685 simple_for return_no_value ] bind: print_array 
[ newfunc3 assign: searcher assign: receiver assign: name 
...
[ newfunc1 assign: self 
  push: ns_obj\_instance\_or\_subclass print return_no_value ] bind: ns_obj.print 
[ newfunc2 assign: self assign: name 
  pick: name pick: self attr: attr attr_call: get func_return ] bind: ns_obj.getattrib 
[ pick: ns_obj.child func_return ] bind: autogen686 
[ pick: name push: child string_equal pushf: autogen686 if 
  pick: name pick: receiver pick: searcher instance_attrib func_return ] bind: autogen687 
[ newfunc3 assign: searcher assign: receiver assign: name 
   ...
   pick: value None == pushf: autogen687 if 
...
[ newfunc1 assign: func 
 ...
 push: set_attr pick: ns_obj.set_attr pick: current_ns attr_call: set 
 push: print pick: ns_obj.print pick: current_ns attr_call: set 
 push: type push: ns_obj pick: current_ns attr_call: set 
[ newfunc1 assign: name 
   push: type pick: name pick: current_ns hashtable.set 
   pick: Done push: _class pick: name str_cat assign: class_name 
   ...
   pick: instance_creator pick: Done push: \_instance\_creator pick: class_name str_cat set_mem_hint return_no_value ] bind: new_ns_class 
pushi: 100 hashtable bind: current_ns 
...
[ check: i func_return ] bind: autogen688 
[ check: i 1 - assign: i 
  pick: i pick: self attr_call: get attr: str pick: c string_equal pushf: autogen688 if ] bind: autogen689 
[ newfunc2 assign: self assign: c 
   pick: self attr_call: len assign: i 
   pushf: autogen689 repeat_if 
   None func_return ] ns_bind: index 
[ pick: index func_return ] bind: autogen690 
[ 
  pick: index pick: self attr_call: get attr: str pick: c string_equal pushf: autogen690 if ] bind: autogen691 
[ newfunc2 assign: self assign: c 
   pick: self attr_call: len 0 pushf: autogen691 simple_for 
...
[ pick: elem pick: result attr_call: append ] bind: autogen692 
[ check: cond drop1 
  pick: self attr_call: next_line assign: elem 
  pick: elem None == not assign: cond 
  pick: cond pushf: autogen692 if ] bind: autogen693 
[ newfunc1 assign: self 
   0 resizable assign: result 
   pick: True assign: cond 
   pushf: autogen693 repeat_if 
   pick: result func_return ] ns_bind: readlines 
[ newfunc1 assign: self 
...
[ pick: new_resizable func_return ] bind: autogen694 
[ pick: self attr_call: next_token assign: token 
  pick: token attr_call: len 0 == pushf: autogen694 if 
  check: token pick: new_resizable attr_call: append ] bind: autogen695 
[ newfunc1 assign: self 
   pick: self attr_call: reset 
   0 resizable assign: new_resizable 
   pushf: autogen695 repeat return_no_value ] ns_bind: to_res 
push: StringIO new_ns_class 
[ newfunc1 assign: pointer 
  pick: pointer get_mem_hint StringIO attr_call: next_token attr: str func_return ] bind: get_class_name 
[ newfunc3 assign: value assign: key assign: creator 
   pick: creator get_class_name names2 attr_call: get attr: attr assign: class_hash 
   pick: key pick: value pick: class_hash attr_call: set return_no_value ] bind: set_method 
[ pick: value to_str func_return ] bind: autogen696 
[ pick: value attr_call: str func_return ] bind: autogen697 
[ newfunc1 assign: value 
  pick: value is_basic pushf: autogen696 pushf: autogen697 if-else return_no_value ] bind: val_to_str 
[ 
  pick: index pick: index pick: arr attr_call: get pick: f call pick: arr attr_call: set ] bind: autogen698 
[ newfunc2 assign: f assign: arr 
  pick: arr attr: len 0 pushf: autogen698 simple_for return_no_value ] bind: map_in_place 
[ 
   make_resizable_rev assign: arr 
   pick: arr pick: to_str map_in_place 
   pick: arr attr: array 1 + pick: arr attr: len str_join assign: joined 
   push: 13 shuffle ] bind: str_cat3 
[ newfunc0 
   push: hello\_world String assign: s 
   pick: s tprint 
   printeol 
...
[ check: handler drop1 
  debugger ] bind: autogen699 
[ pick: error pick: handler call assign: result ] bind: autogen700 
[ check: cond drop1 
  pick: error_handler_index push: exception_handler all_data_stack_pick assign: handler 
  pick: handler None == pushf: autogen699 pushf: autogen700 if-else 
  ...
  s21 assign: cond assign: error_handler_index ] bind: autogen701 
[ newfunc1 assign: error 
   0 assign: error_handler_index 
   pick: True assign: cond 
   pushf: autogen701 repeat_if 
   pick: result func_return ] bind: top_level_exception_handler 
 pick: top_level_exception_handler error_handler_set 
[ 
   pick: Done local_call_stack make_resizable_rev func_return_two ] bind: yield 
...
[ 
  None None func_return_two ] bind: end_yield 
[ newfunc2 assign: temp_filename assign: filename 
   ...
   push: pos_file pick: g attr_call: get set_output 
   pick: Done push: \n pick: temp_filename push: 1\_ str_cat print 
   None set_output 
   pick: filename compile_file 
   push: file pick: g attr_call: get file.close 
   push: pos_file pick: g attr_call: get file.close return_no_value ] bind: compile_temp 
[ 
   current_input_file 
   switch_input_file 
...
[ func_return ] bind: autogen702 
[ push: >>\_ print 
  stdin.next_line assign: source 
  pick: source None == pick: source push: q string_equal || pushf: autogen702 if 
  check: source push: gen/eval.flpc write_file 
  push: gen/eval.flpc run ] bind: autogen703 
[ newfunc0 
  pushf: autogen703 repeat return_no_value ] bind: eval_repl 
 push: debug_separator bind: debug_separator 
[ check: cond drop1 
  tprint 
  printeol 
  pick1 pick: debug_separator == not assign: cond ] bind: autogen704 
[ 
   pick1 pick: debug_separator == not assign: cond 
   pushf: autogen704 repeat_if 
   drop1 ] bind: print_until_sep 
 pushi: 20 hashtable bind: debug_g 
[ pick: func print ] bind: autogen705 
[ pick: func get_class_name assign: class_name 
  pick: class_name print 
  push: \_with\_keys\n print 
  pick: class_name names2 attr_call: get attr: attr tprint 
  printeol 
  push: Type\_help( print 
  pick: class_name print 
  push: \_.\_method)\_to\_get\_help\_on\_specific\_methods\_of\_this\_class. print ] bind: autogen706 
[ pick: True pushi: 3 pick: func print_frame ] bind: autogen707 
[ push: instance\_creator pick: func get_mem_hint str_endswith pushf: autogen706 pushf: autogen707 if-else ] bind: autogen708 
[ newfunc1 assign: func 
   pick: func is_basic pushf: autogen705 pushf: autogen708 if-else 
...
[ check: source push: gen/eval.flpc write_file 
  ...
  push: gen/temp.f run_and_print ] bind: autogen709 
[ pick: True ] bind: autogen710 
[ drop1 ] bind: autogen711 
[ pick: source str_len 0 == ] bind: autogen712 
[ pick: debug_separator 
  push: gen/eval.flpc push: gen/temp.f compile_temp 
  push: gen/temp.f run_and_print 
  push: multiline push: multiline pick: debug_g attr_call: get not pick: debug_g attr_call: set ] bind: autogen713 
[ pick: source push: gen/eval.flpc append_file ] bind: autogen714 
[ pick: source push: r string_equal pushf: autogen713 pushf: autogen714 if-else ] bind: autogen715 
[ push: multiline pick: debug_g attr_call: get ] bind: autogen716 
[ push: gen/temprun.f run_and_print ] bind: autogen717 
[ pick: source push: f string_equal ] bind: autogen718 
[ push: multiline push: multiline pick: debug_g attr_call: get not pick: debug_g attr_call: set 
  push: #Empty push: gen/eval.flpc write_file ] bind: autogen719 
[ pick: source push: m string_equal ] bind: autogen720 
[ drop1 
  push: context push: context pick: debug_g attr_call: get 1 - pick: debug_g attr_call: set 
  look ] bind: autogen721 
[ pick: source push: L string_equal ] bind: autogen722 
[ drop1 
  push: context push: context pick: debug_g attr_call: get 1 + pick: debug_g attr_call: set 
  look ] bind: autogen723 
[ pick: source push: l string_equal ] bind: autogen724 
[ drop1 
  push: height push: height pick: debug_g attr_call: get 1 - pick: debug_g attr_call: set 
  look ] bind: autogen725 
[ pick: source push: d string_equal ] bind: autogen726 
[ drop1 
  push: height push: height pick: debug_g attr_call: get 1 + pick: debug_g attr_call: set 
  look ] bind: autogen727 
[ pick: source push: u string_equal ] bind: autogen728 
[ push: dv2loop_file names2 attr_call: get run ] bind: autogen729 
[ pick: source None == pick: source push: q string_equal || ] bind: autogen730 
[ push: >>\_ print 
  stdin.next_line assign: source 
  pushf: autogen709 pushf: autogen710 pushf: autogen711 pushf: autogen712 pushf: autogen715 pushf: autogen716 pushf: autogen717 pushf: autogen718 pushf: autogen719 pushf: autogen720 pushf: autogen721 pushf: autogen722 pushf: autogen723 pushf: autogen724 pushf: autogen725 pushf: autogen726 pushf: autogen727 pushf: autogen728 pushf: autogen729 pushf: autogen730 pushi: 10 multi-if ] bind: autogen731 
[ 
   ...
   pushf: autogen731 repeat ] bind: debuggerv2 
...
[ newfunc0 
   push: autogen_name push: getter_gen pick: g attr_call: set 
   push: grammar/getter.grammar push: gen/getter_syntax grammar_eval_file_with_out return_no_value ] bind: add_getter_syntax 
[ newfunc2 assign: index assign: obj 
  pick: index pick: obj attr_call: get func_return ] bind: get 
 push: ! pick: get names2 attr_call: set 
[ newfunc1 assign: root 
  pick: FList_class pick: Done push: FCall push: ''' pick: root attr: pos forthep push: FStr 0 pick: root attr_call: get pick: root attr: pos forthep push: FCall push: ''' pick: root attr: pos forthep make_resizable changed_class func_return ] bind: to_forth_conv.TRIPLE_QUOTE 
[ newfunc0 
   push: autogen_name push: triple_quote_gen pick: g attr_call: set 
   push: grammar/triple_quote.grammar push: gen/triple_quote grammar_eval_file_with_out 
...
[ pick: elem to_forth ] bind: autogen732 
[ newfunc1 assign: root 
   pick: Done push: FStr push: Done pick: root attr: pos forthep push: FCall push: pick: pick: root attr: pos forthep make_resizable assign: output 
   pushf: autogen732 pick: root list_comp pick: output extend 
   check: output pick: FList_class flatten assign: output 
   push: FCall pick: root attr: name pick: root attr: pos forthep pick: output attr_call: append 
   pick: FList_class pick: output changed_class func_return ] bind: to_forth_conv.make_resizable 
[ newfunc0 
   push: autogen_name push: resizable_syntax_gen pick: g attr_call: set 
   push: grammar/resizable.grammar push: gen/resizable_syntax grammar_eval_file_with_out 
   push: make_resizable pick: to_forth_conv.make_resizable pick: to_forth_conv_hash attr_call: set return_no_value ] bind: add_resizable_syntax 
[ newfunc0 
   push: autogen_name push: list_comp_syntax_gen pick: g attr_call: set 
   push: grammar/list_comp.grammar push: gen/list_comp_syntax grammar_eval_file_with_out 
   push: list_comp_var pick: to_forth_conv.list_comp_var pick: to_forth_conv_hash attr_call: set return_no_value ] bind: add_list_comp_syntax 
[ newfunc1 assign: root 
   pick: Done 2 pick: root attr_call: get to_forth push: FStr 0 1 pick: root attr_call: get attr_call: get 1 pick: root attr_call: get attr: pos forthep push: FCall push: push: 1 pick: root attr_call: get attr: pos forthep push: \_ 0 pick: root attr_call: get to_forth 1 pick: root attr_call: get attr: pos FQuotep make_resizable assign: output 
   check: output pick: FList_class flatten assign: output 
   push: FCall pick: root attr: name pick: root attr: pos forthep pick: output attr_call: append 
   pick: FList_class pick: output changed_class func_return ] bind: to_forth_conv.list_comp_var 
[ 
   check: index 1 + assign: index 
   pick: index pick: end < ] bind: simple_for_incr 
[ newfunc1 assign: root 
   pick: Done 0 pick: root attr_call: get to_forth push: FCall push: assign: forthep push: FStr push: end 0 pick: root attr_call: get attr: pos forthep 1 pick: root attr_call: get to_forth push: FCall push: assign: forthep push: FStr push: index 1 pick: root attr_call: get attr: pos forthep 2 pick: root attr_call: get to_forth push: FCall push: call 2 pick: root attr_call: get attr: pos forthep push: FCall push: opt.incr pick: root attr: pos forthep push: FCall push: repeat5_if pick: root attr: pos forthep make_resizable_rev assign: output 
   pick: output attr_call: print 
   check: output pick: FList_class flatten assign: output 
   pick: FList_class pick: output changed_class func_return ] bind: to_forth_conv.opt_simple_for 
[ newfunc1 assign: root 
   pick: Done 0 pick: root attr_call: get to_forth push: FCall push: attr_call: forthe push: FStr push: len forthe push: FCall push: assign: forthe push: FStr push: end forthe push: FCall push: 0 forthe push: FCall push: assign: forthe push: FStr push: index forthe push: FCall push: pick: forthe push: FStr push: index forthe push: FCall push: pick: forthe push: FStr push: iterable forthe push: FCall push: attr_call: forthe push: FStr push: get forthe push: FCall push: assign: forthe push: FStr push: elem forthe 1 pick: root attr_call: get to_forth push: FCall push: call forthe push: FCall push: opt.incr forthe push: FCall push: repeat5_if forthe make_resizable_rev assign: output 
   check: output pick: FList_class flatten assign: output 
   pick: FList_class pick: output changed_class func_return ] bind: to_forth_conv.opt_for_in 
[ pick: elem to_forth ] bind: autogen733 
[ newfunc1 assign: root 
   pick: Done push: FStr push: Done pick: root attr: pos forthep push: FCall push: pick: pick: root attr: pos forthep make_resizable assign: output 
   pushf: autogen733 pick: root list_comp pick: output extend 
   check: output pick: FList_class flatten assign: output 
   push: FCall push: str_cat3 pick: root attr: pos forthep pick: output attr_call: append 
   pick: FList_class pick: output changed_class func_return ] bind: to_forth_conv.fmt 
[ newfunc0 
   push: autogen_name push: f_string_gen pick: g attr_call: set 
   push: grammar/f_string.grammar push: gen/f_string grammar_eval_file_with_out return_no_value ] bind: add_f_string_syntax 
[ newfunc2 assign: index assign: obj 
  pick: index pick: obj attr_call: get func_return ] bind: getter 
[ push: Augmented\_assignment\_cannot\_have\_more\_than\_one\_target\_name. error ] bind: autogen734 
[ newfunc1 assign: root 
   0 pick: root attr_call: get assign: names 
   pick: names attr: len 1 == not pushf: autogen734 if 
   pick: Done push: FCall push: pick: pick: names attr: pos forthep 0 pick: names attr_call: get to_forth 2 pick: root attr_call: get to_forth push: FCall 0 1 pick: root attr_call: get attr_call: get 1 pick: root attr_call: get attr: pos forthep push: FCall push: assign: pick: names attr: pos forthep 0 pick: names attr_call: get to_forth make_resizable_rev assign: output 
   pick: FList_class pick: output changed_class func_return ] bind: to_forth_conv.assign_op 
 push: ! pick: getter names2 attr_call: set 
[ push: debugger_v2 print 
  printeol 
  debuggerv2 
  push: dv2loop_file names2 attr_call: get run ] bind: autogen735 
[ newfunc0 
  pushf: autogen735 repeat return_no_value ] bind: dv2loop 
 push: gen/triple_quote.f run_file 
 push: TRIPLE_QUOTE pick: to_forth_conv.TRIPLE_QUOTE pick: to_forth_conv_hash attr_call: set 
 push: gen/resizable_syntax.f run_file 
 push: make_resizable pick: to_forth_conv.make_resizable pick: to_forth_conv_hash attr_call: set 
 push: gen/list_comp_syntax.f run_file 
 push: list_comp_var pick: to_forth_conv.list_comp_var pick: to_forth_conv_hash attr_call: set 
 push: gen/getter_syntax.f run_file 
 push: opt_simple_for pick: to_forth_conv.opt_simple_for pick: to_forth_conv_hash attr_call: set 
