 ...
 [ newfunc0
  pushf: tempgen3 and return1 ] bind: flpcg.rules.single_quotes
 ...
 [ newfunc0
  pushf: tempgen7 and return1 ] bind: flpcg.rules.double_quotes
 [ push: hspaces apply ] bind: tempgen8
 [ push: single_quotes apply ] bind: tempgen9
 [ push: single_quotes apply ] bind: tempgen10
 ...
 [ push: single_quotes apply ] bind: tempgen17
 [ pushf: tempgen9 pushf: tempgen16 pushf: tempgen17 ] bind: tempgen18
 [ pushf: tempgen18 and ] bind: tempgen19
 [ push: double_quotes apply ] bind: tempgen20
 [ push: double_quotes apply ] bind: tempgen21
 ...
 [ push: double_quotes apply ] bind: tempgen28
 ...
 [ newfunc0
  pushf: tempgen33 and return1 ] bind: flpcg.rules.TRIPLE_QUOTE
 [ push: forth apply ] bind: tempgen34
 [ push: func_call apply ] bind: tempgen35
 [ push: name_quote apply ] bind: tempgen36
 [ push: quote apply ] bind: tempgen37
 [ push: parenthesis apply ] bind: tempgen38
 [ push: NUMBER apply ] bind: tempgen39
 [ push: TRIPLE_QUOTE apply ] bind: tempgen40
 ...
 [ newfunc0
  pushf: tempgen43 or return1 ] bind: flpcg.rules.non_block_non_infix
 push: single_quotes pick: flpcg.rules.single_quotes pick: flpcg.rules hashtable.set
 push: double_quotes pick: flpcg.rules.double_quotes pick: flpcg.rules hashtable.set
 push: TRIPLE_QUOTE pick: flpcg.rules.TRIPLE_QUOTE pick: flpcg.rules hashtable.set
 push: TRIPLE_QUOTE pick: flpcg.flagged attr_call: append
