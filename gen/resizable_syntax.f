 ...
 [ newfunc0
  pushf: tempgen16 and func_return ] bind: flpcg.rules.make_resizable
 ...
 [ newfunc0
  pushf: tempgen39 and func_return ] bind: flpcg.rules.make_dict
 [ push: make\udict apply ] bind: tempgen40
 [ push: make\uresizable apply ] bind: tempgen41
 [ push: forth apply ] bind: tempgen42
 [ push: func\ucall apply ] bind: tempgen43
 [ push: name\uquote apply ] bind: tempgen44
 [ push: quote apply ] bind: tempgen45
 [ push: parenthesis apply ] bind: tempgen46
 [ push: NUMBER apply ] bind: tempgen47
 [ push: TRIPLE\uQUOTE apply ] bind: tempgen48
 ...
 [ newfunc0
  pushf: tempgen51 or func_return ] bind: flpcg.rules.non_block_non_infix
 push: make\uresizable pick: flpcg.rules.make_resizable pick: flpcg.rules hashtable.set
 push: make\uresizable pick: flpcg.flagged attr_call: append
 push: make\udict pick: flpcg.rules.make_dict pick: flpcg.rules hashtable.set
 push: make\udict pick: flpcg.flagged attr_call: append
